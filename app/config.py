...
# ---------------------------------------------------------------------------
DB_HOST     = _get_env("DB_HOST",     "tokaido.proxy.rlwy.net")
DB_PORT     = int(_get_env("DB_PORT", "51701"))
DB_NAME     = _get_env("DB_NAME",     "railway")
DB_USER     = _get_env("DB_USER",     "postgres")
DB_PASSWORD = _get_env("DB_PASSWORD", "jpJmNBeVMWJieVJjUIMCcxKvnWBzlduS")
